...
public class windows extends javax.swing.JFrame {
    ...
    public windows() {
        ...
        // Initialize the table model
         // Initialize the table model and set it to jTable2
        ...
        try {
            switch (employeeType) {
                ...
                case "Permanente":
                    ...
                    tableModel.addRow(new Object[]{firstName, lastName, idNumber, numberOfChildren ,"Permanente",employee.calculateSalary() ,yearsOfService + " añosº"});
                    break;
            }
